...
# python accuracy.py --truth /workdir/irk9/data/phg-maize/answer_vcfs/B97_truth.vcf.gz --imputed /workdir/irk9/data/phg-maize/test/impute/imputed/B97_imputed_renamed.vcf -s B97

# python accuracy.py --truth /workdir/smm477/evaluate/truth-vcfs/diploid_maize.vcf.gz --imputed /workdir/irk9/data/phg-maize/target_vcf/0.01x/grits/vcf/renamed.vcf -s Oh7B

# -r chr1 --partial-credit
