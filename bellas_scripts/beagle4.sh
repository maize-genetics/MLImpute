...
#   B97.vcf.gz
#   Mo17.vcf.gz
TARGET_VCF_DIR="/workdir/irk9/data/phg-maize/test2/2x/impute/cleaned_vcfs/cleaned"

# Directory where split target VCFs will be written:
TARGET_SPLIT_DIR="/workdir/irk9/data/phg-maize/test2/2x/beagle/split"
...
OUT_DIR="/workdir/irk9/data/phg-maize/test2/2x/beagle/impute"
