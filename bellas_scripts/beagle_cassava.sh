...
# ./beagle_cassava.sh /workdir/irk9/data/phg-cassava/target_vcf/0.01x/impute/cleaned_vcfs/cleaned /workdir/irk9/data/phg-cassava/target_vcf/0.01x/beagle/split /workdir/irk9/data/phg-cassava/truth-vcfs/beagle_ref/ref_split /workdir/irk9/data/phg-cassava/target_vcf/0.01x/beagle/impute 5

# ./beagle_cassava.sh /workdir/irk9/data/phg-cassava/test2/0.01x/impute/cleaned_vcfs/cleaned /workdir/irk9/data/phg-cassava/test2/0.01x/beagle/split /workdir/irk9/data/phg-cassava/truth-vcfs/beagle_ref/ref_split /workdir/irk9/data/phg-cassava/test2/0.01x/beagle/impute 5

# ./beagle_cassava.sh /workdir/irk9/data/phg-cassava/test2/5.07x/impute/cleaned_vcfs/cleaned /workdir/irk9/data/phg-cassava/test2/5.07x/beagle/split /workdir/irk9/data/phg-cassava/truth-vcfs/beagle_ref/ref_split /workdir/irk9/data/phg-cassava/test2/5.07x/beagle/impute 5


# ./beagle_cassava.sh /workdir/irk9/data/phg-cassava/test2_redo/26.35x/impute/cleaned_vcfs/cleaned /workdir/irk9/data/phg-cassava/test2_redo/26.35x/beagle/split /workdir/irk9/data/phg-cassava/truth-vcfs/beagle_ref/ref_split /workdir/irk9/data/phg-cassava/test2_redo/26.35x/beagle/impute 20

source /workdir/irk9/software/miniconda3/bin/activate beagle3
# ./beagle_cassava.sh /workdir/irk9/data/phg-cassava/test3/2x/impute/cleaned_vcfs/cleaned /workdir/irk9/data/phg-cassava/test3/2x/beagle/split /workdir/irk9/data/phg-cassava/test3/ref_panel/beagle_ref /workdir/irk9/data/phg-cassava/test3/2x/beagle/impute 10
...
for TARGET_VCF in "${TARGET_VCFS[@]}"; do
    ...
    for CHR in ${CHRS}; do
        ...
        REF_VCF="${REF_DIR}/${REF_PREFIX}_chr${CHR}_renamed.vcf.gz"
