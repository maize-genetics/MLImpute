...
# ./beagle_map_cassava.sh /workdir/irk9/data/phg-cassava/target_vcf/0.01x/beagle/split /workdir/irk9/data/phg-cassava/truth-vcfs/beagle_ref/ref_split /workdir/irk9/data/phg-cassava/target_vcf/0.01x/beagle/impute_map /workdir/irk9/data/maps/cassava_beagle_split

# ./beagle_map_cassava.sh /workdir/irk9/data/phg-cassava/test2/0.01x/beagle/split /workdir/irk9/data/phg-cassava/truth-vcfs/beagle_ref/ref_split /workdir/irk9/data/phg-cassava/test2/0.01x/beagle/impute_map /workdir/irk9/data/maps/cassava_beagle_split

# ./beagle_map_cassava.sh /workdir/irk9/data/phg-cassava/test2/5.07x/beagle/split /workdir/irk9/data/phg-cassava/truth-vcfs/beagle_ref/ref_split /workdir/irk9/data/phg-cassava/test2/5.07x/beagle/impute_map /workdir/irk9/data/maps/cassava_beagle_split


# ./beagle_map_cassava.sh /workdir/irk9/data/phg-cassava/test2_redo/26.35x/beagle/split /workdir/irk9/data/phg-cassava/truth-vcfs/beagle_ref/ref_split /workdir/irk9/data/phg-cassava/test2_redo/26.35x/beagle/impute_map /workdir/irk9/data/maps/cassava_beagle_split
