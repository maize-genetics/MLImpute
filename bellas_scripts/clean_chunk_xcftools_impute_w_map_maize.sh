...
TARGET_VCF_DIR=""
OUT_DIR=""
MAP_DIR="/workdir/irk9/data/maps/maize/minimac_impute_maize_map"
THREADS=5
# ./clean_chunk_xcftools_impute_w_map_maize.sh --target-vcf-dir /workdir/irk9/data/phg-maize/target_vcf/2x/impute  --out-dir /workdir/irk9/data/phg-maize/target_vcf/2x/impute_map --map-dir /workdir/irk9/data/maps/maize/minimac_impute_maize_map --threads 5

# ./clean_chunk_xcftools_impute_w_map_maize.sh --target-vcf-dir /workdir/irk9/data/phg-maize/test2/0.01x/impute --out-dir /workdir/irk9/data/phg-maize/test2/0.01x/impute_map --map-dir /workdir/irk9/data/maps/maize/minimac_impute_maize_map --threads 5

# ./clean_chunk_xcftools_impute_w_map_maize.sh --target-vcf-dir /workdir/irk9/data/phg-maize/test2/5.07x/impute --out-dir /workdir/irk9/data/phg-maize/test2/5.07x/impute_map --map-dir /workdir/irk9/data/maps/maize/minimac_impute_maize_map --threads 5
