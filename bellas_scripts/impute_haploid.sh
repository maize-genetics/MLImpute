...
#./impute_haploid.sh --impute-dir /workdir/irk9/data/phg-cassava/test2/0.01x/impute --out-dir /workdir/irk9/data/phg-cassava/test2/0.01x/impute_haploid --threads 5
#./impute_haploid.sh --impute-dir /workdir/irk9/data/phg-cassava/test2/0.1x/impute --out-dir /workdir/irk9/data/phg-cassava/test2/0.1x/impute_haploid --threads 5
#./impute_haploid.sh --impute-dir /workdir/irk9/data/phg-cassava/test2/1x/impute --out-dir /workdir/irk9/data/phg-cassava/test2/1x/impute_haploid --threads 5
#./impute_haploid.sh --impute-dir /workdir/irk9/data/phg-cassava/test2/2x/impute --out-dir /workdir/irk9/data/phg-cassava/test2/2x/impute_haploid --threads 5

#./impute_haploid.sh --impute-dir /workdir/irk9/data/phg-maize/test2/5.07x/impute --out-dir /workdir/irk9/data/phg-maize/test2/5.07x/impute_haploid --threads 5


#./impute_haploid.sh --impute-dir /workdir/irk9/data/phg-cassava/test2_redo/26.35x/impute --out-dir /workdir/irk9/data/phg-cassava/test2_redo/26.35x/impute_haploid --threads 20

#./impute_haploid.sh --impute-dir /workdir/irk9/data/phg-maize/test3/1x/impute --out-dir /workdir/irk9/data/phg-maize/test3/1x/impute_haploid --threads 5
