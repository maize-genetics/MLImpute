...
# ./minimac4.sh --target-dir /workdir/irk9/data/phg-maize/test2/2x/target --ref-msav /workdir/irk9/data/phg-maize/truth-vcfs/maize_pangenome_snps.msav --out-dir /workdir/irk9/data/phg-maize/test2/2x/minimac --threads 5 

# ./minimac4.sh --target-dir /workdir/irk9/data/phg-maize/test2/0.01x/target --ref-msav /workdir/irk9/data/phg-maize/truth-vcfs/maize_pangenome_snps.msav --out-dir /workdir/irk9/data/phg-maize/test2/0.01x/minimac_redo --threads 5 


# ./minimac4.sh --target-dir /workdir/irk9/data/phg-maize/target_vcf/2x --ref-msav /workdir/irk9/data/phg-maize/truth-vcfs/maize_pangenome_snps.msav --out-dir /workdir/irk9/data/phg-maize/target_vcf/2x/minimac_redo --threads 5 

# ./minimac4.sh --target-dir /workdir/irk9/data/phg-maize/test2/5.07x/target --ref-msav /workdir/irk9/data/phg-maize/truth-vcfs/maize_pangenome_snps.msav --out-dir /workdir/irk9/data/phg-maize/test2/5.07x/minimac --threads 5

# ./minimac4.sh --target-dir  /workdir/irk9/data/phg-maize/test3/2x/target --ref-msav /workdir/irk9/data/phg-maize/test3/maize_test3_ref.msav --out-dir /workdir/irk9/data/phg-maize/test3/2x/minimac --threads 5
