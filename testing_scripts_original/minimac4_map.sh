...
# ./minimac4_map.sh --target-dir /workdir/irk9/data/phg-maize/target_vcf/2x/impute/cleaned_vcfs/cleaned  --ref-msav /workdir/irk9/data/phg-maize/truth-vcfs/maize_pangenome_snps.msav  --out-dir /workdir/irk9/data/phg-maize/target_vcf/2x/minimac_map  --map /workdir/irk9/data/maps/maize/minimac_impute_maize_map/combined_cleaned.map --threads 5

# ./minimac4_map.sh --target-dir /workdir/irk9/data/phg-maize/test2/0.01x/impute/cleaned_vcfs/cleaned --ref-msav /workdir/irk9/data/phg-maize/truth-vcfs/maize_pangenome_snps.msav  --out-dir /workdir/irk9/data/phg-maize/test2/0.01x/minimac_map  --map /workdir/irk9/data/maps/maize/minimac_impute_maize_map/combined_cleaned.map --threads 5

# ./minimac4_map.sh --target-dir /workdir/irk9/data/phg-maize/test2/5.07x/impute/cleaned_vcfs/cleaned --ref-msav /workdir/irk9/data/phg-maize/truth-vcfs/maize_pangenome_snps.msav --out-dir /workdir/irk9/data/phg-maize/test2/5.07x/minimac_map --map /workdir/irk9/data/maps/maize/minimac_impute_maize_map/combined_cleaned.map --threads 5
...
LOG_FILE=""
THREADS=5
MAP="/workdir/irk9/data/maps/maize/minimac_impute_maize_map/combined_cleaned.map"
